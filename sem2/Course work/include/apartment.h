 ...
 */
 ...
 /// Maximum length for address string.
 #define ADDRESS_STRING_BUFFER_SIZE ((size_t)256)
 ...
 typedef struct apartment {
     ...
     /// Full address string (null-terminated, max length ADDRESS_STRING_BUFFER_SIZE-1).
     char address[ADDRESS_STRING_BUFFER_SIZE];
